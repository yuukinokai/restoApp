...
public class MenuItem
{
  ...
  public boolean removeOrder(Order aOrder)
  {
    ...
    //Unable to remove aOrder, as it must always have a menuItem
    if (!this.equals(aOrder.getMenuItem()))
    {
