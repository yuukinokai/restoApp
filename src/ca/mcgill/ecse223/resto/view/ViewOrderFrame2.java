...
public class ViewOrderFrame2 extends JFrame {
	
	public ViewOrderFrame2(RestoAppPage restoAppPage, Order o) {
	    ...
	    List<Seat> seatsOrder = o.getSeats();
		for(OrderItem oi : orderItems) {
			List<Seat> seats = oi.getSeats();
			//Boolean added = false;
			String s = oi.toString() + " split in " + seats.size() + " for Seats";
			for(Seat seat : seats) {
